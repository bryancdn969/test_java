...
import com.antawa.controller.filter.CORSFilter;
	...
	public WebMvcConfigurer corsConfigurer() {
		return new WebMvcConfigurerAdapter() {
			...
			public void addCorsMappings(CorsRegistry registry) {
				registry.addMapping("/**").allowedOrigins("*");//.allowedOrigins("http://localhost:8100", "http://localhost:8110","http://localhost:4200");
			}
		};
	}
